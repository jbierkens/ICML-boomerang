...
n_batches = 50 # number of batches in batch means both for ess_pdmp and ESS.
...
using CSV
CSV.write(string("results-by-dimension-with-", observations, "-observations.csv"), df)
